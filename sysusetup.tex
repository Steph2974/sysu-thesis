...
\sysusetup{
  title                = {个性化出行的生成式推荐算法研究},
  title*               = {A Study on Generative Recommendation Algorithms for Personalized Travel}, % 英文标题
  author               = {熊元亮},
  % author*              = {XIONG Yuanliang}, % 英文作者
  speciality           = {人工智能},
  % speciality*          = {Artificial Intelligence},
  supervisor           = {刘威~副教授},
  % supervisor*          = {Prof. LIU Wei},
  % practice-supervisor  = {XXX~教授, XXX~教授},
  % practice-supervisor* = {Prof. XXX, Prof. XXX},
  % date                 = {2017-05-01},  % 完成时间，默认为今日
  % professional-type    = {专业学位类型},
  % professional-type*   = {Professional degree type},
   department           = {人工智能学院},  % 院系，本科生需要填写
   student-id           = {22330122},  % 学号，本科生需要填写
